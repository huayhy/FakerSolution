...
using Faker.Solution.Authorization.Accounts;
...
namespace Faker.Solution.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        /// 示例:<br/>
        /// </remarks>
        /// <param name="input">CreateUserDto</param>
        ...
        /// 示例:<br/>
        /// </remarks>
        /// <param name="input">EntityDto<long></param>
        /// <returns></returns> 
        ...
        /// 示例:<br/>
        /// </remarks>
        /// <param name="input">ChangeUserLanguageDto</param>
        /// <returns></returns> 
