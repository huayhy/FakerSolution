...
using Faker.Solution.Web.Models.Account;
using Faker.Solution.Web.Views.Shared.Components.TenantChange;

namespace Faker.Solution.Web.Controllers
{
    public class AccountController : SolutionControllerBase
    {
